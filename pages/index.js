    ...
    <>
      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-white/70 border-b border-slate-200">
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm">
            ...
            <a href="#iletisim" className="hover:text-slate-700">İletişim</a>
          </div>
        ...
        >
          <div className="flex flex-col items-start p-4 space-y-4 text-sm">
            ...
            <a href="#iletisim" className="hover:text-slate-700 w-full" onClick={() => setMenuOpen(false)}>İletişim</a>
      ...
      <section className="py-24 text-center">
        ...
        <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
          E-İmza, Mali Mühür, KEP Adresi, IT Danışmanlığı ve E-Dönüşüm Çözümleriyle işletmenizi dijital dünyada güçlendirin.
        </p>
        <div className="mt-6 flex justify-center gap-4">
          <Button className="bg-orange-500 hover:bg-orange-600">Hemen Başla</Button>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white shadow p-6 rounded-lg">
              ...
              <p className="text-sm text-slate-600">Güvenli dijital imza çözümleriyle işlemlerinizi hızlandırın.</p>
            </div>
            <div className="bg-white shadow p-6 rounded-lg">
              <h3 className="font-semibold text-lg mb-2">Mali Mühür</h3>
              <p className="text-sm text-slate-600">Mali mühür hizmetleriyle resmi belgelerinizi güven altına alın.</p>
            </div>
            <div className="bg-white shadow p-6 rounded-lg">
              <h3 className="font-semibold text-lg mb-2">KEP Adresi</h3>
              <p className="text-sm text-slate-600">Kayıtlı elektronik posta adresi çözümlerimizle yasal güvence sağlayın.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="iletisim" className="py-16 bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-600 mb-4">Size en kısa sürede dönüş yapmamız için formu doldurun.</p>
